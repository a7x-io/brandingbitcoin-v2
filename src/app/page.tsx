...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            {/* About Section */}
            <section id="about" className="container mx-auto px-4 py-20 relative overflow-hidden hidden">
                {/* Background Elements */}
                <div className="absolute inset-0 opacity-5">
                    <div className="absolute top-20 left-10 w-32 h-32 bg-primary rounded-full blur-3xl"></div>
                    <div className="absolute bottom-20 right-10 w-40 h-40 bg-secondary rounded-full blur-3xl"></div>
                ...
                <div className="relative z-10">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-5xl md:text-6xl font-bold text-foreground mb-6 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text">
                            Why Choose BrandingBitcoin?
                        </h2>
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                            We understand the unique challenges and opportunities in the cryptocurrency space. 
                            Our team combines deep industry knowledge with creative design expertise to deliver 
                            branding solutions that resonate with crypto audiences.
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="group p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-start space-x-4">
                                        <div className="w-12 h-12 bg-gradient-to-br from-primary to-primary/80 rounded-xl flex items-center justify-center shadow-lg">
                                            <span className="text-primary-foreground text-lg font-bold">₿</span>
                                        </div>
                                        <div className="flex-1">
                                            <h3 className="text-lg font-semibold text-foreground mb-2">Crypto Industry Expertise</h3>
                                            <p className="text-muted-foreground text-sm leading-relaxed">
                                                Deep understanding of blockchain technology, market dynamics, and crypto culture.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="group p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-lg font-semibold text-foreground mb-2">Professional Design Quality</h3>
                                            <p className="text-muted-foreground text-sm leading-relaxed">
                                                Award-winning design team with expertise in modern branding and visual identity.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="group p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-muted-foreground text-sm leading-relaxed">
                                                Rapid turnaround times without compromising on quality or attention to detail.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="group p-6 bg-white/50 backdrop-blur-sm rounded-2xl border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    <div className="flex items-start space-x-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-muted-foreground text-sm leading-relaxed">
                                                Continuous maintenance, updates, and support to keep your brand thriving.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="relative">
                            <div className="sticky top-8">
                                <div className="bg-gradient-to-br from-primary/5 via-white/80 to-secondary/5 backdrop-blur-sm rounded-3xl p-8 border border-white/30 shadow-2xl">
                                    <div className="text-center">
                                        <div className="relative mb-8">
                                            <div className="w-28 h-28 bg-gradient-to-br from-primary to-primary/80 rounded-full flex items-center justify-center mx-auto shadow-2xl">
                                        ...
                                        <p className="text-muted-foreground mb-6 leading-relaxed">
                                            We&apos;ve helped dozens of Bitcoin businesses establish their brand presence 
                                            and achieve market success across the globe.
                                        </p>
